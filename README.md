...
# Image construction
The containerized framework is currently deployed as Docker images. The images can be build using the Dockerfile contained in this repository using the following commands:
